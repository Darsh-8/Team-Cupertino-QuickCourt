...
export interface CourtEnhancedAttributes {
  id: number;
  venueId: number;
  name: string;
  sportType: string;
...
interface CourtEnhancedCreationAttributes extends Optional<CourtEnhancedAttributes, 
...
class CourtEnhanced extends Model<CourtEnhancedAttributes, CourtEnhancedCreationAttributes> implements CourtEnhancedAttributes {
  public id!: number;
...
CourtEnhanced.init(
  ...
  {
    sequelize,
    modelName: 'CourtEnhanced',
    tableName: 'courts_enhanced',
    timestamps: true,
    indexes: [
      {
        fields: ['venueId']
