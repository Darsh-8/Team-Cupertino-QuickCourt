      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        ...
        <div className="mt-4 text-center">
          ...
          >
            ...
            <span>Browse Photo Gallery ({venue.images.length} photos)</span>
          </button>
        </div>
      </div>
            ...
            <div className="sticky top-24 bg-white border border-gray-200 rounded-xl p-6 shadow-lg">
              ...
              <div className="border-t pt-4 mb-6">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  <button className="flex items-center justify-center space-x-2 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center animate-fade-in">
          <div className="relative w-full h-full flex items-center justify-center p-4">
            ...
            <button
              onClick={() => {
                if (showFullGallery) {
                  setSelectedImageIndex((prev) => (prev - 1 + venue.images.length) % venue.images.length);
                } else {
                  prevImage();
                }
              }}
            ...
            <button
              onClick={() => {
                if (showFullGallery) {
                  setSelectedImageIndex((prev) => (prev + 1) % venue.images.length);
                } else {
                  nextImage();
                }
              }}
            ...
            {/* Main Image */}
            <img
              src={venue.images[showFullGallery ? selectedImageIndex : currentImageIndex]}
              alt={`${venue.name} ${(showFullGallery ? selectedImageIndex : currentImageIndex) + 1}`}
            ...
            <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full">
              <span className="text-white text-sm">
                {(showFullGallery ? selectedImageIndex : currentImageIndex) + 1} / {venue.images.length}
              </span>
            </div>
