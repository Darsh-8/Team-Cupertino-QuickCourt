...
const SearchResults = () => {
  ...
  const saveCurrentSearch = () => {
    const searchQuery = `${filters.searchQuery} - ${filters.sports.join(', ')} - ${sortBy}`;
          ...
          <div className="absolute top-4 left-4">
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
              ...
              {venue.availability === 'available' ? 'Available' : 
               venue.availability === 'limited' ? 'Limited' : 'Booked'}
            </span>
          </div>
        </div>
    ...
    showSaveSearch && (
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl max-w-md w-full p-6">
          ...
          <p className="text-gray-600 mb-4">Save this search to quickly access it later.</p>
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  {expandedFilters.amenities && (
                    <div className="mt-3 space-y-2">
                      {['Parking', 'WiFi', 'Cafe', 'Shower', 'AC', 'Locker'].map((amenity) => (
