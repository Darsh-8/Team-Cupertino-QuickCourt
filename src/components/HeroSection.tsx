...
import { MapPin, Search, Clock, Users, Plus, Minus, Zap, ChevronDown, Filter, Star, TrendingUp } from 'lucide-react';
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-rose-500 text-white rounded-full hover:bg-rose-600 transition-colors font-medium"
            >
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-full hover:border-gray-400 transition-colors font-medium"
            >
              <Filter className="w-4 h-4" />
              <span>Quick Filters</span>
            </button>
            <button
              onClick={() => handleQuickFilter('sort', 'rating')}
              className="flex items-center space-x-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-full hover:border-gray-400 transition-colors font-medium"
            >
            ...
            <button
              onClick={() => handleQuickFilter('sort', 'popular')}
              className="flex items-center space-x-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-full hover:border-gray-400 transition-colors font-medium"
            >
          ...
          {/* Quick Filters Panel */}
          {showQuickFilters && (
            <div className="mt-6 p-6 bg-gray-50 rounded-xl max-w-2xl mx-auto">
              <h3 className="font-semibold text-gray-900 mb-4">Quick Filters</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <button
                  onClick={() => handleQuickFilter('price', 'under-1000')}
                  className="p-3 text-sm bg-white border border-gray-200 rounded-lg hover:border-rose-500 hover:text-rose-500 transition-colors"
                >
                  Under ₹1000
                </button>
                <button
                  onClick={() => handleQuickFilter('rating', '4.5')}
                  className="p-3 text-sm bg-white border border-gray-200 rounded-lg hover:border-rose-500 hover:text-rose-500 transition-colors"
                >
                  4.5+ Rating
                </button>
                <button
                  onClick={() => handleQuickFilter('amenity', 'parking')}
                  className="p-3 text-sm bg-white border border-gray-200 rounded-lg hover:border-rose-500 hover:text-rose-500 transition-colors"
                >
                  Parking
                </button>
                <button
                  onClick={() => handleQuickFilter('amenity', 'ac')}
                  className="p-3 text-sm bg-white border border-gray-200 rounded-lg hover:border-rose-500 hover:text-rose-500 transition-colors"
                >
                  AC Courts
                </button>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white md:rounded-full rounded-xl shadow-lg border border-gray-200 md:p-2 p-6 hover:shadow-xl transition-shadow duration-300 relative">
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0">
              ...
              <div 
                className={`flex-1 md:p-4 p-3 md:rounded-full rounded-lg cursor-pointer transition-colors min-w-0 relative ${
              ...
              <div 
                className={`hidden md:block flex-1 p-4 rounded-full cursor-pointer transition-colors min-w-0 ${
